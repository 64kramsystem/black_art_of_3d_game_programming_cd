...
if (!loaded)
   ...
   Sound_Load("BLZCLK.VOC"  ,(sound_ptr)&digital_FX[BLZCLK_VOC  ],1);
   Sound_Load("BLZEXP1.VOC" ,(sound_ptr)&digital_FX[BLZEXP1_VOC ],1);
   Sound_Load("BLZEXP2.VOC" ,(sound_ptr)&digital_FX[BLZEXP2_VOC ],1);
   Sound_Load("BLZLAS.VOC"  ,(sound_ptr)&digital_FX[BLZLAS_VOC  ],1);
   Sound_Load("BLZNRG.VOC"  ,(sound_ptr)&digital_FX[BLZNRG_VOC  ],1);
   Sound_Load("BLZSHLD.VOC" ,(sound_ptr)&digital_FX[BLZSHLD_VOC ],1);
   Sound_Load("BLZTAC.VOC"  ,(sound_ptr)&digital_FX[BLZTAC_VOC  ],1);
   Sound_Load("BLZSCN.VOC"  ,(sound_ptr)&digital_FX[BLZSCN_VOC  ],1);
   Sound_Load("BLZMISS.VOC" ,(sound_ptr)&digital_FX[BLZMISS_VOC ],1);

   Sound_Load("BLZBIOS.VOC" ,(sound_ptr)&digital_FX[BLZBIOS_VOC ],1);
   Sound_Load("BLZENTR.VOC" ,(sound_ptr)&digital_FX[BLZENTR_VOC ],1);
   Sound_Load("BLZABRT.VOC" ,(sound_ptr)&digital_FX[BLZABRT_VOC ],1);
   Sound_Load("BLZSEL.VOC"  ,(sound_ptr)&digital_FX[BLZSEL_VOC  ],1);
   Sound_Load("BLZKEY.VOC"  ,(sound_ptr)&digital_FX[BLZKEY_VOC  ],1);
   Sound_Load("BLZDIAL.VOC"  ,(sound_ptr)&digital_FX[BLZDIAL_VOC  ],1);

   Sound_Load("BLZLOS.VOC"  ,(sound_ptr)&digital_FX[BLZLOS_VOC  ],1);
   Sound_Load("BLZWIN.VOC"  ,(sound_ptr)&digital_FX[BLZWIN_VOC  ],1);
...
Sound_Unload((sound_ptr)&digital_FX[BLZCLK_VOC  ]);
Sound_Unload((sound_ptr)&digital_FX[BLZEXP1_VOC ]);
Sound_Unload((sound_ptr)&digital_FX[BLZEXP2_VOC ]);
Sound_Unload((sound_ptr)&digital_FX[BLZLAS_VOC  ]);
Sound_Unload((sound_ptr)&digital_FX[BLZNRG_VOC  ]);
Sound_Unload((sound_ptr)&digital_FX[BLZSHLD_VOC ]);
Sound_Unload((sound_ptr)&digital_FX[BLZTAC_VOC  ]);
Sound_Unload((sound_ptr)&digital_FX[BLZSCN_VOC  ]);
Sound_Unload((sound_ptr)&digital_FX[BLZMISS_VOC ]);

Sound_Unload((sound_ptr)&digital_FX[BLZENTR_VOC ]);
Sound_Unload((sound_ptr)&digital_FX[BLZABRT_VOC ]);
Sound_Unload((sound_ptr)&digital_FX[BLZSEL_VOC  ]);
Sound_Unload((sound_ptr)&digital_FX[BLZKEY_VOC  ]);
Sound_Unload((sound_ptr)&digital_FX[BLZDIAL_VOC ]);

Sound_Unload((sound_ptr)&digital_FX[BLZLOS_VOC  ]);
Sound_Unload((sound_ptr)&digital_FX[BLZWIN_VOC ]);
...
Sound_Unload((sound_ptr)&digital_FX[BLZBIOS_VOC]);
